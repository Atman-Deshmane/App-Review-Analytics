                ...
                <div className="h-full flex flex-col">
                            ...
                            <div>
                                <div className="text-sm font-bold tracking-tight leading-tight">
                                    {manifest && manifest[appId]
                                        ? manifest[appId].name
                                        : (appId ? appId.split('.').pop()?.charAt(0).toUpperCase()! + appId.split('.').pop()?.slice(1) : 'App Analytics')}
                                </div>
                    ...
                    <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${activeTab === 'overview' ? 'bg-indigo-600 text-white shadow-indigo-900/20 shadow-lg' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${activeTab === 'themes' ? 'bg-indigo-600 text-white shadow-indigo-900/20 shadow-lg' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${activeTab === 'reviews' ? 'bg-indigo-600 text-white shadow-indigo-900/20 shadow-lg' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}
                        >
                    ...
                    <div className="p-4 border-t border-slate-800 mt-auto">
                        <button
                            ...
                            className="w-full flex items-center justify-center space-x-2 px-4 py-3 rounded-xl bg-slate-800 text-slate-300 hover:bg-slate-700 hover:text-white transition-all mb-4"
                        >
                            <Search size={16} />
                        ...
                        </div>        <div className="text-xs text-slate-500 text-center">
