                    ...
                    <div className="flex items-center space-x-8">
                        ...
                        <div className="hidden md:block text-right">
                            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center justify-end">
                                Total Volume
                                <span
                                    className="ml-1 w-3.5 h-3.5 rounded-full bg-slate-200 text-slate-500 text-[8px] font-bold flex items-center justify-center cursor-help"
                                    title="Includes the reviewer's own vote (+1 per review) to reflect true community impact."
                                >i</span>
                            </div>
